...
def get_model(config):
    ...
    if model_type == 'vae':
        ...
        return ConfigurableAutoencoder(
            ...
            latent_dim=latent_dim,
            input_mode=model_cfg.get('input_mode', 'dose_ct'),
            fusion_method=model_cfg.get('fusion_method', 'weighted_sum'),
            architecture='resnet',
    ...
    elif model_type == 'resnet_unet_ae':
        return ConfigurableAutoencoder(
            input_channels=in_channels,
            output_channels=model_cfg.get('output_channels', 1),
            base_filters=base_filters,
            ...
            use_bottleneck=False,
            input_size=input_size,
            bilinear_upsampling=model_cfg.get('bilinear_upsampling', False),
            dropout_mlp=model_cfg.get('dropout_mlp', 0.1),
            dropout_attention=0.0,
            dropout_decoder=model_cfg.get('dropout_decoder', 0.1),
            dropout_features=model_cfg.get('dropout_features', 0.1),
        ...
        return ConfigurableAutoencoder(
            ...
            latent_dim=latent_dim,
            input_mode=model_cfg.get('input_mode', 'ct_only'),
            fusion_method=model_cfg.get('fusion_method', 'weighted_sum'),
            architecture='conv',
            use_bottleneck=False,
            input_size=input_size,
        ...
        return ConfigurableAutoencoder(
            ...
            latent_dim=latent_dim,
            input_mode=model_cfg.get('input_mode', 'fused_only'),
            fusion_method=model_cfg.get('fusion_method', 'weighted_sum'),
            architecture='conv',
            use_bottleneck=False,
            input_size=input_size,
